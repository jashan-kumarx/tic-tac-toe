 ...
 * template to the port the api runner actually got). SCORE_API_PORT (a bare
 * port) is still honoured. Defaults to http://localhost:5050 for plain
...
module.exports = function (app) {
  const target = toProxyTarget(process.env.BACKEND_URL || process.env.SCORE_API_PORT);
